<div>
        ...
        <form class="my-3 shadow py-3 px-3 glass_effect rounded" wire:submit.prevent="store" enctype="multipart/form-data">
            ...
            <h1 class="text-center display-3 mb-4 text_accent text_shadow">{{__('ui.Add Article')}}</h1>
            ...
            <div class="mb-3">
                <label for="category" class="form-label text_main">{{__('ui.Category')}}</label>
                <select wire:model.defer="category" id="category" class="form-control @error ('category') is-invalid @enderror">
                    <option value="">{{__('ui.Select Category')}}</option>
           ...
           <div class="row">
            <div class="col-12">
                <p class="text-white">{{__('ui.Photo preview')}}:</p>
                <div class="row border_accent rounded shadow py-4">
